...
def realizar_compra(cpf_usuario, driver):
    ...
    with driver.session() as session:
        ...
        if not usuario_data:
            ...
            if resposta == 'S':
                ...
                if cpf_usuario is None:
                    ...
                    return
                # Após o cadastro, tenta buscar o usuário novamente
        ...
        if not enderecos:
            ...
            resposta = input().upper()
            if resposta == 'S':
                endereco_entrega = cadastrar_endereco("usuario", cpf_usuario)  # Passa "usuario" e cpf_usuario
...
#     endereco_entrega_id = endereco_entrega.id  # Extrair o ID do Node
#     tx.run(query, cpf_usuario=cpf_usuario, produtos=produtos, endereco_entrega_id=endereco_entrega_id, total=total, data_hora=data_hora)
